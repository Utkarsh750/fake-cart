      ...
      <header className="text-gray-600 body-font shadow-lg">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <Link to={'/'} className="flex cursor-pointer title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span className="ml-3 text-xl">FakeCart</span>
          </Link>
          ...
          <Link to={'/cart'} className="inline-flex items-center text-white bg-purple-500 border-0 py-2 px-4 focus:outline-none hover:bg-red-700 rounded text-base mt-4 md:mt-0">
            Go to Cart
            <svg
              fill="none"
              stroke="currentColor"
